...
MONDO:excludeNonDisease | non disease | This is a blanket exclusion reason for cases where we do not have the resources to actually check what the class is. | 
