...
MONDO:omim_formerly | Used on OMIM synonyms whose labels end with ", formerly", denoting a status similar to `owl:deprecated`. | synonyms | N | [OMIM:101000](https://omim.org/entry/101000?search=FORMERLY&highlight=formerly), Schwannomatosis, vestibular (Acoustic schwannomas, bilateral, formerly)
