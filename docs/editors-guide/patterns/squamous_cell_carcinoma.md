...
{location\([owl:Thing](http://www.w3.org/2002/07/owl#Thing)\)} squamous cell carcinoma

## Annotations 

* annotation: exact_synonym\([oio:hasExactSynonym](http://purl.obolibrary.org/obo/oio_hasExactSynonym)\)  
text: {location\([owl:Thing](http://www.w3.org/2002/07/owl#Thing)\)} squamous cell carcinoma

## Definition 

A squamous cell carcinoma that involves the {location\([owl:Thing](http://www.w3.org/2002/07/owl#Thing)\)}.
