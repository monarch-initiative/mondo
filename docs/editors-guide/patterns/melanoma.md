...
{location\([owl:Thing](http://www.w3.org/2002/07/owl#Thing)\)} melanoma

## Annotations 

* annotation: exact_synonym\([oio:hasExactSynonym](http://purl.obolibrary.org/obo/oio_hasExactSynonym)\)  
text: {location\([owl:Thing](http://www.w3.org/2002/07/owl#Thing)\)} melanoma

## Definition 

A melanoma that involves the {location\([owl:Thing](http://www.w3.org/2002/07/owl#Thing)\)}.
